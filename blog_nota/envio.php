...
</svg>Subir Examen</div>
<div
    class="container"
>
  

<h5 style="text-align: center;MARGIN-TOP:20PX">Subir preguntas para el examen</h5>




<form action="conect3.php" method="post">
...
<div class="mb-3">
    ...
    <input
        ...
        placeholder=""
    />
    <small id="helpId" class="form-text text-muted">envie su pregunta</small>
</div>
...
<button type="reset" class="btn btn-primary" style="float: right;">Borrar</button>
